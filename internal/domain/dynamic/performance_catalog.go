...
var machinePerformanceMetrics = []PerformanceMetricDefinition{
	...
	{Name: "ntp_offset_abs_ms", DisplayName: "时钟绝对偏移", Scope: "machine", Category: "system", Unit: "ms", ValueKind: "gauge", Aggregation: "max", IntervalSeconds: 60, Available: true, Description: "chrony 报告的系统时钟偏移绝对值，用于双向偏移告警"},
