...
func NewRouter(core *app.App) http.Handler {
	...
	managerHandler := handler.NewManagerHandler(core.ManagerRuntime, core.DatabaseMaintenance)
	managerHAHandler := handler.NewManagerHAHandler(core.ManagerHA)
	...
	mysqlHandler := handler.NewMySQLHandler(core.MySQLService, core.HistogramService)
	binlogAnalysisHandler := handler.NewBinlogAnalysisHandler(core.BinlogAnalysisService)
	taskHandler := handler.NewTaskHandler(core.TaskService)
	clusterUpgradeHandler := handler.NewClusterUpgradeHandler(core.ClusterUpgradeService)
	...
	mux.HandleFunc("/api/v1/manager/database/wal", managerHandler.HandleDatabaseWAL)
	...
	mux.HandleFunc("/api/v1/manager/ha", managerHAHandler.HandleOverview)
	mux.HandleFunc("/api/v1/manager/ha/config", managerHAHandler.HandleConfig)
	mux.HandleFunc("/api/v1/manager/ha/nodes", managerHAHandler.HandleNodes)
	mux.HandleFunc("/api/v1/manager/ha/interfaces", managerHAHandler.HandleInterfaces)
	mux.HandleFunc("/api/v1/manager/ha/nodes/action", managerHAHandler.HandleNodeAction)
	mux.HandleFunc("/api/v1/manager/ha/vip/switch", managerHAHandler.HandleVIPSwitch)
	mux.HandleFunc("/api/v1/manager/ha/bootstrap/config", managerHAHandler.HandleBootstrapConfig)
	mux.HandleFunc("/api/v1/manager/ha/bootstrap/binary", managerHAHandler.HandleBootstrapBinary)
	...
	mux.HandleFunc("/api/v1/mysql/histograms", mysqlHandler.HandleHistograms)
	mux.HandleFunc("/api/v1/mysql/binlog-analysis", binlogAnalysisHandler.HandleCollection)
	mux.HandleFunc("/api/v1/mysql/binlog-analysis/", binlogAnalysisHandler.HandleTask)
	mux.HandleFunc("/api/v1/mysql/account-presets", mysqlHandler.HandleAccountPresets)
	mux.HandleFunc("/api/v1/sql-diagnostics/config", sqlDiagnosticHandler.HandleConfig)
	mux.HandleFunc("/api/v1/sql-diagnostics/explain", sqlDiagnosticHandler.HandleExplain)
	mux.HandleFunc("/api/v1/sql-diagnostics/current", sqlDiagnosticHandler.HandleCurrent)
	mux.HandleFunc("/api/v1/sql-diagnostics/history", sqlDiagnosticHandler.HandleHistory)
	mux.HandleFunc("/api/v1/sql-diagnostics/top", sqlDiagnosticHandler.HandleTop)
	mux.HandleFunc("/api/v1/sql-diagnostics/slow", sqlDiagnosticHandler.HandleSlow)
	mux.HandleFunc("/api/v1/sql-diagnostics/kill", sqlDiagnosticHandler.HandleKill)
	mux.HandleFunc("/api/v1/sql-diagnostics/kill-audits", sqlDiagnosticHandler.HandleKillAudits)
	mux.HandleFunc("/api/v1/performance/catalog", performanceHandler.HandleCatalog)
	mux.HandleFunc("/api/v1/performance/metrics", performanceHandler.HandleMetrics)
	mux.HandleFunc("/api/v1/performance/flamegraphs", flameGraphHandler.HandleProfiles)
	mux.HandleFunc("/api/v1/performance/flamegraphs/schedules", flameGraphHandler.HandleSchedules)
	mux.HandleFunc("/api/v1/performance/flamegraphs/schedules/", flameGraphHandler.HandleScheduleByID)
	mux.HandleFunc("/api/v1/performance/flamegraphs/", flameGraphHandler.HandleProfileByID)
	...
	mux.HandleFunc("/api/v1/tasks/cluster-automation/results", taskHandler.HandleClusterAutomationResults)
	...
	mux.HandleFunc("/api/v1/tasks/database-inspection/results", taskHandler.HandleDatabaseInspectionResults)
	mux.HandleFunc("/api/v1/tasks/database-inspection/history", taskHandler.HandleDatabaseInspectionHistory)
	mux.HandleFunc("/api/v1/tasks/database-inspection/report", taskHandler.HandleDatabaseInspectionReport)
	mux.HandleFunc("/api/v1/tasks/database-inspection/data", taskHandler.HandleDatabaseInspectionData)
	mux.HandleFunc("/api/v1/tasks/mysql-install", taskHandler.HandleCreateMySQLInstallTask)
	mux.HandleFunc("/api/v1/tasks/mysql-lifecycle", taskHandler.HandleMySQLLifecycle)
	...
	mux.HandleFunc("/api/v1/tasks/mysql-indexes", taskHandler.HandleMySQLIndexes)
	mux.HandleFunc("/api/v1/tasks/mysql-online-ddl", taskHandler.HandleMySQLOnlineDDL)
	mux.HandleFunc("/api/v1/tasks/mysql-archive", taskHandler.HandleMySQLArchive)
	...
	mux.HandleFunc("/api/v1/tasks/mysql-cluster-upgrade/plan", clusterUpgradeHandler.HandlePlan)
	mux.HandleFunc("/api/v1/tasks/mysql-cluster-upgrade/start", clusterUpgradeHandler.HandleStart)
	mux.HandleFunc("/api/v1/tasks/mysql-cluster-upgrade", clusterUpgradeHandler.HandleRun)
	...
	mux.HandleFunc("/api/v1/ai/", aiHandler.Handle)
	mux.HandleFunc("/api/v1/software/packages/", packageHandler.HandleAgentPackageDownload)
